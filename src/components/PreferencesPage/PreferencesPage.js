...
<div style={{
  ...
  <div className={classes.root}>
      ...
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={InterviewSkills1} onChange={handleChange} name="InterviewSkills1" color="primary"/>}
            label="Interview Skills"
          />
          <FormControlLabel
            control={<Checkbox checked={JobApplications1} onChange={handleChange} name="JobApplications1" color="primary"/>}
            label="Job Applications"
          />
          <FormControlLabel
            control={<Checkbox checked={WorkplaceEtiquette1} onChange={handleChange} name="WorkplaceEtiquette1" color="primary"/>}
      ...
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={Productivity1} onChange={handleChange} name="Productivity1" color="primary"/>}
            label="Productivity"
          />
          <FormControlLabel
            control={<Checkbox checked={Communication1} onChange={handleChange} name="Communication1" color="primary"/>}
            label="Communication"
          />
          <FormControlLabel
            control={<Checkbox checked={Music1} onChange={handleChange} name="Music1" color="primary"/>}
            label="Music"
          />
        </FormGroup>
      </FormControl>
...
<div className={classes.root}>
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={WebDevelopment2} onChange={handleChange} name="WebDevelopment2" />}
            label="Web Development"
          />
          <FormControlLabel
            control={<Checkbox checked={GameDevelopment2} onChange={handleChange} name="GameDevelopment2" />}
            label="Game Development"
          />
          <FormControlLabel
            control={<Checkbox checked={MobileDevelopment2} onChange={handleChange} name="MobileDevelopment2" />}
            label="Mobile Development"
          />
        </FormGroup>
      </FormControl>
      ...
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={ARVR2} onChange={handleChange} name="ARVR2" />}
            label="AR/VR"
          />
          <FormControlLabel
            control={<Checkbox checked={Cybersecurity2} onChange={handleChange} name="Cybersecurity2" />}
            label="Cybersecurity"
          />
          <FormControlLabel
            control={<Checkbox checked={MachineLearningAndAI2} onChange={handleChange} name="MachineLearningAndAI2" />}
            label="Machine Learning and AI"
          />
        </FormGroup>
      </FormControl>
      ...
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={InterviewSkills2} onChange={handleChange} name="InterviewSkills2" />}
            label="Interview Skills"
          />
          <FormControlLabel
            control={<Checkbox checked={JobApplications2} onChange={handleChange} name="JobApplications2" />}
            label="Job Applications"
          />
          <FormControlLabel
            control={<Checkbox checked={WorkplaceEtiquette2} onChange={handleChange} name="WorkplaceEtiquette2" />}
            label="Workplace Etiquette"
          />
        </FormGroup>
      </FormControl>
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <FormGroup>
          <FormControlLabel
            control={<Checkbox checked={Productivity2} onChange={handleChange} name="Productivity2" />}
            label="Productivity"
          />
          <FormControlLabel
            control={<Checkbox checked={Communication2} onChange={handleChange} name="Communication2" />}
            label="Communication"
          />
          <FormControlLabel
            control={<Checkbox checked={Music2} onChange={handleChange} name="Music2" />}
            label="Music"
          />
        </FormGroup>
      </FormControl>
